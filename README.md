...
> **프로젝트 이동 안내**: 현재 저장소는 유지보수되지 않으며 [Notipy-DiscordBot/Notipy](https://github.com/Notipy-DiscordBot/Notipy) 로 이전되었습니다.
...
자세한 내용은 [CONTRIBUTING.md](docs/ko/CONTRIBUTING.md)를 확인하세요!
...
- 또는 봇에게 DM 하세요!
- 공식 GitHub 저장소: [Notipy-DiscordBot](https://github.com/Notipy-DiscordBot/Notipy)
