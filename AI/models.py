...
role_assignments = Table(
    ...
    Column('user_id', Integer, ForeignKey('users.developer_id'), primary_key=True)
)
...
class User(Base):
    ...
    roles_assigned = relationship("Role", secondary=role_assignments, back_populates="assigned_users")
...
class Role(Base):
    ...
    assigned_users = relationship("User", secondary=role_assignments, back_populates="roles_assigned")
